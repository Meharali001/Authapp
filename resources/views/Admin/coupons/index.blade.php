            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <span><a href="{{ route('admin.coupon.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i> Add New</a></span>
...
{{--                                                <a href="{!! route('admin.coupon.edit', $result->id) !!}" class="btn btn-primary btn-sm waves-effect waves-light"><i class="feather icon-edit"></i></a>--}}
                                                ...
                                                <form action="{!! URL::route('admin.coupon.destroy', $result->id) !!}" method="POST" id="deleteForm{!! $result->id !!}">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
