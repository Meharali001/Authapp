                    ...
                    <div class="row m-0" style="background-color: black;">
                        <div class="col-lg-6 d-lg-block d-none text-center align-self-center px-1 py-0">
                            @if($siteSettings->logo_path)
                                <img src="{!! $siteSettings->logo_path !!}" alt="branding logo">
                            @else
                                <img src="{!! asset('assets/admin/app-assets/images/pages/logo.png') !!}" alt="branding logo">
                            @endif
                        </div>
                        <div class="col-lg-6 col-12 p-0">
                            <div class="card rounded-0 mb-0 px-2">
                                ...
                                <p class="px-2">Welcome to {!! $siteSettings->site_title !!} Admin, please login to your account.</p>
